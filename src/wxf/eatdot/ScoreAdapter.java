...
public class ScoreAdapter extends ArrayAdapter<ScoreItem>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			LayoutInflater inflater = (LayoutInflater) EATDOTActivity.instance.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//		Log.v("listcontent", content.timeStr + content.timeused);
		if (content != null) {
			...
			timeused.setText((position + 1) + "¡¢" + content.scores + "·Ö");
